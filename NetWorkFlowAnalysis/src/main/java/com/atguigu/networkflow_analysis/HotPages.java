...
//        DataStream<String> inputStream = env.readTextFile(resource.getPath());
        ...
        SingleOutputStreamOperator<PageViewCount> windowAggStream = dataStream.filter(data -> "GET".equals(data.getMethod()))   // 进行过滤 讲请求方法为GET的保留下来
...
//                PageViewCount cunrrentItemViewCount = pageViewCounts.get(i);
                Map.Entry<String, Long> cunrrentItemViewCount = pageViewCounts.get(i);
                resultBuilder.append("No").append(i + 1).append(":")
                        .append(" 页面url = ").append(cunrrentItemViewCount.getKey())
                        .append(" 浏览量 = ").append(cunrrentItemViewCount.getValue())
                        .append("\n");
            }
            resultBuilder.append("================================================\n\n");
...
//            pageViewCountListState.clear();// 会将listState中状态全部清除
